...
namespace MvcMusicStore.Models
{
    public partial class ShoppingCart
    {
        ...
        public static ShoppingCart GetCart(MusicStoreEntities storeDB, HttpContext context)
        {
        ...
        public int RemoveFromCart(int id)
        {
            // Get the cart
            var cartItem = _storeDB.Carts
                .Single(cart => cart.CartId == ShoppingCartId && cart.RecordId == id);
        ...
        public decimal GetTotal()
        {
            ...
            var cartItems = _storeDB.Carts
                .Include(c => c.Album)
                .Where(cart => cart.CartId == ShoppingCartId);

            decimal? total = (from cartItem in cartItems
        ...
        // We're using HttpContext to allow access to cookies and session
